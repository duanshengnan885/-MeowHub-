...
target1 = '''                    if "256k" in m_id_lower or "k2.6" in m_id_lower or "k2.5" in m_id_lower:
                        context = "256K"
...
replacement1 = '''                    if "256k" in m_id_lower or "k2.6" in m_id_lower or "k2.5" in m_id_lower:
                        context = "256K"
...
target2 = '''                    elif provider == "deepseek":
                        if "chat" in m_id_lower:
                            name = "DeepSeek-V3"
                        elif "reasoner" in m_id_lower:
                            name = "DeepSeek-R1"'''

replacement2 = '''                    elif provider == "deepseek":
                        if "v4" in m_id_lower:
                            name = "DeepSeek-V4"
